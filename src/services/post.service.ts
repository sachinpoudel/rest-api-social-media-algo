...
const friendsIds = user?.friends.map((friend:any) => friend._id) as unknown as Object[];
const followingIds = user?.following.map((follow:any) => follow._id) as unknown as Object[];
